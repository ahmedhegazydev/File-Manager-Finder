...
public class FragmentForAnyPath extends android.support.v4.app.Fragment implements GridView.OnItemClickListener,
...
//            sharedPreferences = getActivity().getSharedPreferences(HOME_PATH, MODE);
    ...
    private void getPassedBundles() {
        Bundle bundle = getArguments();
        KEY_HOME_PATH = (String) bundle.get(MainActivity.KEY_HOME_PATH);
