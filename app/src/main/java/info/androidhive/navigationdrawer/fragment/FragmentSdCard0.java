...
public class FragmentSdCard0 extends Fragment implements GridView.OnItemClickListener,
    ...
    final static String KEY_HOME_PATH = "HOME_PATH";
    final static String KEY_PATHS_ARRAYLIST = "PATHS_ARRAYLIST";
...
//            sharedPreferences = getActivity().getSharedPreferences(HOME_PATH, MODE);
            ...
            if (sharedPreferences.contains("path")) {
                tvPath.setText(sharedPreferences.getString("path", ""));
            } else {
                path = Environment.getExternalStorageDirectory().getAbsolutePath();
                tvPath.setText(path);
...
//        item.setActionView(sv);
    ...
    private void getHomePath() {
        if (sharedPreferences.contains("path")) {
            String homePath = sharedPreferences.getString("path", "");
